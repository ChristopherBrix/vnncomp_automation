...
def create_app():
    app = Flask(__name__,
                static_url_path='',
                static_folder='templates/theme'
                )

    # Flask-WTF requires an enryption key - the string can be anything
    app.config["SECRET_KEY"] = os.getenv('SECRET_KEY', 'some secret key')
    app.config["SQLALCHEMY_DATABASE_URI"] = "sqlite:////var/www/html/vnncomp/data/vnncomp.sqlite"

    from vnncomp.utils.task import Task, BenchmarkTask, ToolkitTask
