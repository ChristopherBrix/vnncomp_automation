...
class ToolkitTask(Task):
    ...
    _db_restart_after_postinstallation = db.Column(db.Boolean)
    ...
    @property
    def restart_after_postinstallation(self) -> bool:
        return self._db_restart_after_postinstallation
    ...
    def __init__(
        ...
        self._db_restart_after_postinstallation = _restart_after_postinstallation
    ...
    def save_new(
        ...
        task = ToolkitTask(
            ...
            _restart_after_postinstallation=_restart_after_postinstallation
        )
        ...
        task._define_steps(
            ...
            _restart_after_postinstallation,
        )
        task._db_current_step.execute()
        return task
    ...
    def _define_steps(
        ...
        restart_after_postinstallation: bool,
    ):
        self._db_steps = [
        ...
        if pause_after_postinstallation:
            self._db_steps.append(TaskPause(self).add_to_db())
        if restart_after_postinstallation:
            self._db_steps.append(ToolkitRestart(self).add_to_db())
