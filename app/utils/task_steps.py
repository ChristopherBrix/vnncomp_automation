...
class BenchmarkCreate(TaskStep):
    ...
    def _create(self):
        from app.utils.aws_instance import AwsManager, AwsInstanceType
    ...
    def queue_position(self):
        from app.utils.task import BenchmarkTask
...
class ToolkitCreate(TaskStep):
    ...
    def _create(self):
        from app.utils.aws_instance import AwsManager
    ...
    def queue_position(self):
        from app.utils.task import ToolkitTask
